...
const Mission = () => {
  return (
    <div className="lg:bg-accent w-screen flex flex-col lg:flex-row lg:px-15 lg:py-20 justify-center items-center lg:gap-20">
      <div>
        ...
        <div className="border-black flex items-center justify-center flex-col lg:flex-row lg:border lg:h-64 lg:gap-8 lg:rounded-3xl">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="text-base font-montserrat text-text-accent mx-8 text-center font-normal my-4 lg:text-left lg:mx-0 lg:text-white">
              As your Integrated Wellness Coach, I will help you unlock inner
              strength and create a life of freedom and purpose.
            </div>
          ...
          {missions.map((mission, index) => {
            return (
              <div className="flex gap-3 my-3 mx-1" key={index}>
                <img
                  src="assets/common/svgs/mission.svg"
                  alt="menu"
                  className="h-8 w-8"
                />
                <div className="font-montserrat text-xl text-text-accent font-medium lg:text-white">
                  {mission}
                </div>
              </div>
            );
