  ...
  return (
    <div className="h-[calc(100vh-64px)] lg:h-auto w-screen flex flex-col">
      <div className="lg:h-[calc(100vh-64px)] flex flex-col">
        <div
          className={`h-[65vh] lg:h-4/5 w-screen justify-center flex items-end relative`}
        >
      ...
      <div className="flex justify-center items-center flex-1 bg-accent lg:bg-transparent lg:py-15">
        <div className="relative">
          ...
          <img
            src="/assets/common/svgs/mission-left.svg"
            alt="logo"
            className="absolute left-1 -top-4 hidden lg:flex"
          />
          <img
