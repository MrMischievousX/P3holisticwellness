  ...
  return (
    <div className=''>
      <div
        ...
        className={`h-[calc(100vh-64px)] w-screen justify-center bg-no-repeat bg-cover bg-center flex items-center py-4 transition-opacity duration-700 opacity-100]`}
      >
